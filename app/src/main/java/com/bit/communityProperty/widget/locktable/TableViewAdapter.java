...
public class TableViewAdapter extends RecyclerView.Adapter<TableViewAdapter.TableViewHolder> {
     ...
     * 第一列数据
     */
    private ArrayList<WorkTime> mLockColumnDatas;
    /**
     * 表格数据
     */
     ...
     * @param isLockColumn
     */
    public TableViewAdapter(Context mContext, ArrayList<WorkTime> mLockColumnDatas, ArrayList<ArrayList<WorkTime>> mTableDatas, boolean isLockColumn, boolean isLockRow) {
