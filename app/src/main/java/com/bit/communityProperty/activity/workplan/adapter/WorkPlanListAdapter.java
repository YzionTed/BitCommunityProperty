package com.bit.communityProperty.activity.workplan.adapter;
...
public class WorkPlanListAdapter extends RecyclerView.Adapter {
    private List<String> mList;
    private LayoutInflater mLayoutInflater;
    private Context context;

    public WorkPlanListAdapter(Context context, List<String> list) {
        this.mList = list;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_work_plan, parent, false));
    }
